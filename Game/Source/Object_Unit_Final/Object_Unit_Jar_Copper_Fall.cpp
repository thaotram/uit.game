#include "Object_Unit_Jar_Copper_Fall.h"
...
Object_Unit_Jar_Copper_Fall::Object_Unit_Jar_Copper_Fall(float x, float y)
...
void Object_Unit_Jar_Copper_Fall::ObjectUpdateEvent(float dt) {
	//#Tính UnitDamage
	tUnit = tUnitDamage =
	RECT{ 
		(LONG)xx - 14,
