...
#define Object_Collision_Enemy(type, name) Collision_Player_Enemy_Each(pPlayer, &m##type##_##name)
#define Object_Collision_Static(type, name) Collision_Player_Static_Each(pPlayer, &m##type##_##name)
